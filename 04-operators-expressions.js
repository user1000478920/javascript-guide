...
<≠=<≠=<≠=<≠=Comparision Operators=≠>=≠>=≠>=≠>=≠>
 ...
 These operators check for a certain conditions
...
/*
 ...
 These are used to check more than one condition
 and output a boolean

 Operator | Logical | purpose
——————————+—————————+———————————>
...
let g = 10;
let h = 11;
console.log( g ,"<" , h ,"AND", g ,"!=", h ,"?", g<h && g != h )
console.log( g ,">" , h ,"OR", g ,"!=", h ,"?", g>h || g != h )
console.log( g ,">" , h ,"OR", g ,"===", h ,"?", g>h || g === h )
